...
public class ExcelGenerationController {
    ...
    @PutMapping("/pdf/{id}")
	public boolean update(@PathVariable("id") final String id, @RequestBody ExcelRequest request) throws IOException{
         return excelfileservice.updateExcel(id,request);
	}
    ...
    public ResponseEntity<ExcelResponse> deleteExcel(@PathVariable String id) throws FileNotFoundException {
        ...
        ExcelFil fileDeleted = excelfileservice.deleteExcel(id);
